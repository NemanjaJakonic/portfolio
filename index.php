...
<body>
    ...
    <div id="wrapper">
        <section id="main">
            ...
            <div class="logo">
                <img src="./img/logo.gif" title="Shoutout to my girlfriend who made this photo ;)" alt="" />
            </div>
            ...
            <div class="projects">
                <div id="project1">
                    ...
                    <div class="project project6">
                        ...
                        <a href="https://laravel-blog-nemanja.herokuapp.com/" target="_blank"
                            class="btn btn-project">Demo</a>
                        <a href="https://github.com/NemanjaJakonic/laravel-blog" target="_blank"
                            class="btn btn-project">Code</a>
                        <p class="p6">
                            This is simple blog I have built while learning Laravel for the project I did for a client.
                        </p>
                    </div>
                </div>
                <div id="project1">
                    ...
                    <div class="project project1">
                        <div class="overlay"></div>
                        <a href="https://kokoro.netlify.com/" target="_blank" class="btn btn-project">Demo</a>
                        <a href="https://github.com/NemanjaJakonic/kokoro" target="_blank"
                            class="btn btn-project">Code</a>
                        <p class="p1">
                ...
                <div id="project2">
                    ...
                    <div class="project project2">
                        <div class="overlay"></div>
                        <a href="https://rockpaperscissors-nemanja.netlify.com/" target="_blank"
                            class="btn btn-project">Demo</a>
                        <a href="https://github.com/NemanjaJakonic/rockpaperscissors" target="_blank"
                            class="btn btn-project">Code</a>
                        <p class="p2">
                ...
                <div id="project3">
                    ...
                    <div class="project project3">
                        <div class="overlay"></div>
                        <a href="https://nemanja-weatherjs.netlify.com" target="_blank" class="btn btn-project">Demo</a>
                        <a href="https://github.com/NemanjaJakonic/weatherJS" target="_blank"
                            class="btn btn-project">Code</a>
                ...
                <div id="project4">
                    ...
                    <div class="project project4">
                        <div class="overlay"></div>
                        <a href="https://formulaf1stats.netlify.com/" target="_blank" class="btn btn-project">Demo</a>
                        <a href="https://github.com/NemanjaJakonic/Formula-F1-Stats" target="_blank"
                            class="btn btn-project">Code</a>
                        <p class="p4">
                ...
                <div id="project5">
                    ...
                    <div class="project project5">
                        <div class="overlay"></div>
                        <a href="https://lyricsapp-nemanja.netlify.com/" target="_blank"
                            class="btn btn-project">Demo</a>
                        <a href="https://github.com/NemanjaJakonic/LyricsApp" target="_blank"
                            class="btn btn-project">Code</a>
                        <p class="p5">
        ...
        <section id="contact">
            ...
            <form method="post" action="contact.php">
                <p>Name:</p>
                <input type="text" name="name" id="name" value="<?php $name?>" placeholder="Enter your name..."
                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter name..'" required />
                <br />
                <p>Email:</p>
                <input type="email" name="email" id="email" value="<?php $email?>" placeholder="Enter your email..."
                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your email...'" required />
                <br />
                <p>Message:</p>
                <br />
                <textarea name="message" id="message" value="<?php $message?>" placeholder="Enter your message..."
                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your message...'" cols="30"
                    rows="5" required></textarea>
                <br />
                <input type="submit" name="submit" value="Submit" class="btn submit" id="submit" />
            </form>
            <footer>
                <a href="https://github.com/NemanjaJakonic" target="_blank"><i class="fab fa-github fa-2x"></i></a>
                <a href="https://github.com/NemanjaJakonic" target="_blank"><i class="fab fa-linkedin fa-2x"></i></a>
                <a href="#wrapper" id="btn" class="btn secondary-btn"><i class="fas fa-chevron-up"></i></a>
            </footer>
        </section>
    </div>
