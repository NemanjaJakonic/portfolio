      ...
      <div class="projects">
        <div id="project1">
          ...
          <div class="project project1">
            ...
            <a href="https://github.com/NemanjaJakonic/kokoro" target="_blank" class="btn btn-project">Code</a>
            <p class="p1">
        ...
        <div id="project2">
          ...
          <div class="project project2">
            <div class="overlay"></div>
            <a href="https://rockpaperscissors-nemanja.netlify.com/" target="_blank" class="btn btn-project">Demo</a>
        ...
        <div id="project3">
          ...
          <div class="project project3">
            ...
            <a href="https://github.com/NemanjaJakonic/weatherJS" target="_blank" class="btn btn-project">Code</a>
        ...
        <div id="project5">
          ...
          <div class="project project5">
            <div class="overlay"></div>
            <a href="https://lyricsapp-nemanja.netlify.com/" target="_blank" class="btn btn-project">Demo</a>
            <a href="https://github.com/NemanjaJakonic/LyricsApp" target="_blank" class="btn btn-project">Code</a>
            <p class="p5">
    ...
    <section id="contact">
      ...
      <form method="post" action="contact.php">
        ...
        <textarea name="message" id="message" value="<?php $message?>" placeholder="Enter your message..."
          onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your message...'" cols="30" rows="5"
          required></textarea>
        <br />
